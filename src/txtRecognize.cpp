...
std::string textRead(cv::Mat matTestingImage) {
    ...
    cv::FileStorage fsClassifications("../data/classifications.xml", cv::FileStorage::READ);        // open the classifications file
    ...
    cv::FileStorage fsTrainingImages("../data/images.xml", cv::FileStorage::READ);          // open the training images file
